...
func TestConsensusSpecAltair(t *testing.T) {
	...
	tests := []SpecTestStruct{
		...
		},
		{
			...
			s3:   []any{&codegen_views.BeaconBlock{}, &codegen_views.AltairBeaconBlock{}},
		},
		{
			name: "BeaconBlockBody",
			s:    &altair.BeaconBlockBody{},
			s2:   &codegen.AltairBeaconBlockBody{},
			s3:   []any{&codegen_views.BeaconBlockBody{}, &codegen_views.AltairBeaconBlockBody{}},
		},
		{
		...
		},
		{
			...
			s3:   []any{&codegen_views.BeaconState{}, &codegen_views.AltairBeaconState{}},
		},
		{
			name: "Checkpoint",
			s:    &phase0.Checkpoint{},
		...
		},
		{
			...
			s3:   []any{&codegen_views.SignedBeaconBlock{}, &codegen_views.AltairSignedBeaconBlock{}},
		},
		{
