...
func TestConsensusSpecDeneb(t *testing.T) {
	...
	tests := []SpecTestStruct{
		...
		},
		{
			...
			s3:   []any{&codegen_views.BeaconBlock{}, &codegen_views.DenebBeaconBlock{}},
		},
		{
			name: "BeaconBlockBody",
			s:    &deneb.BeaconBlockBody{},
			s2:   &codegen.DenebBeaconBlockBody{},
			s3:   []any{&codegen_views.BeaconBlockBody{}, &codegen_views.DenebBeaconBlockBody{}},
		},
		{
		...
		},
		{
			...
			s3:   []any{&codegen_views.BeaconState{}, &codegen_views.DenebBeaconState{}},
		},
		{
			name: "BlobIdentifier",
		...
		},
		{
			...
			s3:   []any{&codegen_views.ExecutionPayload{}, &codegen_views.DenebExecutionPayload{}},
		},
		{
			name: "ExecutionPayloadHeader",
			s:    &deneb.ExecutionPayloadHeader{},
			s2:   &codegen.DenebExecutionPayloadHeader{},
			s3:   []any{&codegen_views.ExecutionPayloadHeader{}, &codegen_views.DenebExecutionPayloadHeader{}},
		},
		{
			name: "Fork",
			s:    &phase0.Fork{},
		...
		},
		{
			...
			s3:   []any{&codegen_views.SignedBeaconBlock{}, &codegen_views.DenebSignedBeaconBlock{}},
		},
		{
