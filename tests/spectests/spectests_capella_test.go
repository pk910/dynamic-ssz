...
func TestConsensusSpecCapella(t *testing.T) {
	...
	tests := []SpecTestStruct{
		...
		},
		{
			...
			s3:   []any{&codegen_views.BeaconBlock{}, &codegen_views.CapellaBeaconBlock{}},
		},
		{
			name: "BeaconBlockBody",
			s:    &capella.BeaconBlockBody{},
			s2:   &codegen.CapellaBeaconBlockBody{},
			s3:   []any{&codegen_views.BeaconBlockBody{}, &codegen_views.CapellaBeaconBlockBody{}},
		},
		{
		...
		},
		{
			...
			s3:   []any{&codegen_views.BeaconState{}, &codegen_views.CapellaBeaconState{}},
		},
		{
		...
		},
		{
			...
			s3:   []any{&codegen_views.ExecutionPayload{}, &codegen_views.CapellaExecutionPayload{}},
		},
		{
			name: "ExecutionPayloadHeader",
			s:    &capella.ExecutionPayloadHeader{},
			s2:   &codegen.CapellaExecutionPayloadHeader{},
			s3:   []any{&codegen_views.ExecutionPayloadHeader{}, &codegen_views.CapellaExecutionPayloadHeader{}},
		},
		{
			name: "Fork",
			s:    &phase0.Fork{},
		...
		},
		{
			...
			s3:   []any{&codegen_views.SignedBeaconBlock{}, &codegen_views.CapellaSignedBeaconBlock{}},
		},
		{
