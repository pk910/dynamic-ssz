...
type GloasAttestation struct {
	...
	Data            *Phase0AttestationData `ssz-index:"1"`
...
type GloasBeaconBlockBody struct {
	...
	ETH1Data                  *Phase0ETH1Data                      `ssz-index:"1"`
	Graffiti                  [32]byte                             `ssz-index:"2"  ssz-size:"32"`
	ProposerSlashings         []*Phase0ProposerSlashing            `ssz-index:"3"  ssz-type:"progressive-list"`
	...
	Deposits                  []*Phase0Deposit                     `ssz-index:"6"  ssz-type:"progressive-list"`
	VoluntaryExits            []*Phase0SignedVoluntaryExit         `ssz-index:"7"  ssz-type:"progressive-list"`
...
type GloasBeaconState struct {
	...
	Fork                          *Phase0Fork                        `ssz-index:"3"`
	LatestBlockHeader             *Phase0BeaconBlockHeader           `ssz-index:"4"`
	...
	ETH1Data                      *Phase0ETH1Data                    `ssz-index:"8"`
	ETH1DataVotes                 []*Phase0ETH1Data                  `ssz-index:"9"  dynssz-max:"EPOCHS_PER_ETH1_VOTING_PERIOD*SLOTS_PER_EPOCH" ssz-max:"2048"`
	ETH1DepositIndex              uint64                             `ssz-index:"10"`
	Validators                    []*Phase0Validator                 `ssz-index:"11" ssz-type:"progressive-list"`
...
type GloasExecutionPayload struct {
	...
	BaseFeePerGasUint256 *uint256.Int         `ssz-index:"11" ssz-size:"32"`
