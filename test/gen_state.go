...
// Hash: 1ef7055c048ffb23ca17186cd729b398c2a5b416c25b67875ad1472ab48b3b71
...
func (t *TestBeaconState) HashTreeRootWithDyn(ds sszutils.DynamicSpecs, hh sszutils.HashWalker) error {
	...
	fn2 := func(t []phase0.Root) (err error) { // []phase0.Root:HISTORICAL_ROOTS_LIMIT:32
	...
	fn3 := func(t []*phase0.ETH1Data) (err error) { // []*phase0.ETH1Data:EPOCHS_PER_ETH1_VOTING_PERIOD*SLOTS_PER_EPOCH
	...
	fn4 := func(t []*phase0.Validator) (err error) { // []*phase0.Validator:VALIDATOR_REGISTRY_LIMIT
	...
	fn5 := func(t []phase0.Gwei) (err error) { // []phase0.Gwei:VALIDATOR_REGISTRY_LIMIT
		hasLimit, maxLen, err := ds.ResolveSpecValue("VALIDATOR_REGISTRY_LIMIT")
		if err != nil {
			return err
		}
	...
	fn8 := func(t []altair.ParticipationFlags) (err error) { // []altair.ParticipationFlags:VALIDATOR_REGISTRY_LIMIT
		hasLimit, maxLen, err := ds.ResolveSpecValue("VALIDATOR_REGISTRY_LIMIT")
		if err != nil {
			return err
		}
	...
	fn9 := func(t []uint64) (err error) { // []uint64:VALIDATOR_REGISTRY_LIMIT
		hasLimit, maxLen, err := ds.ResolveSpecValue("VALIDATOR_REGISTRY_LIMIT")
		if err != nil {
			return err
		}
	...
	fn12 := func(t []*capella.HistoricalSummary) (err error) { // []*capella.HistoricalSummary:HISTORICAL_ROOTS_LIMIT
		hasLimit, maxLen, err := ds.ResolveSpecValue("HISTORICAL_ROOTS_LIMIT")
		if err != nil {
			return err
		}
	...
	fn13 := func(t *TestBeaconState) (err error) { // *main.TestBeaconState
		idx := hh.Index()
		// Field #0 'GenesisTime'
