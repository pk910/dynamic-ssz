...
# Optional custom header comment for generated files. {hash} and {version}
# are substituted. Keep the first line matching the Go convention
# `^// Code generated .* DO NOT EDIT\.$` — a warning is printed otherwise.
header: |
