...
// {version} placeholders are substituted during generation.
const DefaultHeaderTemplate = "// Code generated by dynamic-ssz. DO NOT EDIT.\n" +
	"// Hash: {hash}\n" +
	"// Version: {version} (https://github.com/pk910/dynamic-ssz)\n"

// generatedHeaderPattern is the Go convention for machine-generated files
// (https://pkg.go.dev/cmd/go#hdr-Generate_Go_files_by_processing_source).
// Tooling (go, golangci-lint, code review tools) only treats a file as
// generated when its first line matches this pattern.
...
//	cg.Generate()
func (cg *CodeGenerator) SetPackageName(packageName string) error {
	if !token.IsIdentifier(packageName) || token.Lookup(packageName).IsKeyword() || packageName == "_" {
		return fmt.Errorf("invalid package name %q: must be a non-blank Go identifier", packageName)
	}
...
// SetHeaderTemplate sets a custom header comment template for generated files.
//
