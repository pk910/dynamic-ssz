...
// CycleBatchA and CycleBatchB form one cycle generated in two batches:
// CycleBatchA in the main batch, CycleBatchB in the extended batch, so the
// second batch reaches the first through code generated by an earlier run.
