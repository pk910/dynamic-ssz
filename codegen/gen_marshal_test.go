...
func TestGenerateMarshalUnsupportedType(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := generateMarshal(desc, codeBuilder, typePrinter, "", options, nil)
			if err == nil {
...
func TestMarshalContainerWithNestedUnsupportedType(t *testing.T) {
	...
	err := generateMarshal(containerDesc, codeBuilder, typePrinter, "", options, nil)
	if err == nil {
...
func TestMarshalVectorWithNestedUnsupportedType(t *testing.T) {
	...
	err := generateMarshal(vectorDesc, codeBuilder, typePrinter, "", options, nil)
	if err == nil {
...
func TestMarshalListWithNestedUnsupportedType(t *testing.T) {
	...
	err := generateMarshal(listDesc, codeBuilder, typePrinter, "", options, nil)
	if err == nil {
...
func TestMarshalUnionWithNestedUnsupportedType(t *testing.T) {
	...
	err := generateMarshal(unionDesc, codeBuilder, typePrinter, "", options, nil)
	if err == nil {
...
func TestMarshalTypeWrapperWithNestedUnsupportedType(t *testing.T) {
	...
	err := generateMarshal(wrapperDesc, codeBuilder, typePrinter, "", options, nil)
	if err == nil {
