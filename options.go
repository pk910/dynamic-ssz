...
// instance in and leaves the process-wide configuration untouched. While the
// process-wide limit is set, tree finalization (GetTree, treeproof hashing)
// also spreads wide tree levels across that many workers.
