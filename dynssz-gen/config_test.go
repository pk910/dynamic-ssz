...
func TestApplyToConfig_Header(t *testing.T) {
	path := writeTempConfig(t, `
package: fmt
output: out.go
header: |
...
`)
	...
	t.Run("FromFile", func(t *testing.T) {
		cfg := Config{}
		if _, err := fc.applyToConfig(&cfg, map[string]bool{}, filepath.Dir(path)); err != nil {
			t.Fatalf("applyToConfig: %v", err)
		}
		want := "// Code generated by mytool. DO NOT EDIT.\n// Hash: {hash}\n"
		if cfg.HeaderTemplate != want {
			t.Errorf("HeaderTemplate = %q, want %q", cfg.HeaderTemplate, want)
		}
	})

	t.Run("CLIOverride", func(t *testing.T) {
		cfg := Config{HeaderTemplate: "// Code generated by cli. DO NOT EDIT.\n"}
		if _, err := fc.applyToConfig(&cfg, map[string]bool{"header": true}, filepath.Dir(path)); err != nil {
			t.Fatalf("applyToConfig: %v", err)
		}
		if cfg.HeaderTemplate != "// Code generated by cli. DO NOT EDIT.\n" {
			t.Errorf("CLI -header should win, got %q", cfg.HeaderTemplate)
		}
	})
}
